...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''{red}[{luc}Đớp{red}][{vang}Đợi xíu em iuu❣️{red}][{luc}{str(value)[0:5]}{red}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{red}[{luc}Đớp{red}][{vang}Đợi xíu em iuu❣️{red}][{luc}{str(value)[0:5]}{red}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{red}[{luc}Đớp{red}][{vang}Đợi xíu em iuu❣️{red}][{luc}{str(value)[0:5]}{red}]''', '               ', end = '\r')
...
def countdown(value):
	while not(value <= 1) :
		value -= 0.123
		print(f'''{red}[{luc}Đớp{red}][{vang}COUNTDOWN{red}][{lam}{str(value)[0:5]}{red}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{red}[{luc}Đớp{red}][{vang}COUNTDOWN{red}][{lam}{str(value)[0:5]}{red}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{red}[{luc}Đớp{red}][{vang}COUNTDOWN{red}][{lam}{str(value)[0:5]}{red}]''', '               ', end = '\r')
...
def chongblock(delaybl):
	for i in range(delaybl, -1, -1):
		Write.Print(f'Đang hoạt động chống block sẽ chạy lại sau {i} giây  \r',Colors.green_to_white,interval=0.0001);sleep(1); print('                                                        ', end = '\r')
...
def Nhap_Cookie():
    ...
    while True:
        demck += 1
        ck = input(f'\033[1;32mNhập Cookie Facebook Thứ: {vang}{demck}{trang}: ')
        if ck == '' and demck > 1:
            break
        _info = _Infofb(ck)
        if _info == False:
            ...
            print(red+"-"*70)
            print(f'{luc}UID FACEBOOK: {vang}{_info[1]} {red}| {luc}NAME FACEBOOK: {vang}{_info[2]}')
            print(red+"-"*70)
            listck.append(ck)
    return listck
...
def Main():
    ...
    while True:
        if os.path.exists('configttc.txt'):
            ...
            if login.json()['status'] == 'success':
                ...
                print(f'{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản {lam}{user}')
                print(f'{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TTC Mới')
                chon = Write.Input(f'Nhập Lựa Chọn Của Bạn: ',Colors.purple_to_blue,interval=0.0001)
                if chon == '2':
        ...
        if not os.path.exists('configttc.txt'):
            tk = input(f'\033[1;32mNhập Access_token Ttc{trang}: ')
        ...
        if login.json()['status'] == 'success':
            ...
            print(red+"-"*70)
            print(f"{luc}Tên Tài Khoản: {trang}{user} | {luc}Xu Hiện Tại: {trang}{sodu}")
            print(red+"-"*70)
            break
        else:
            os.remove ('configttc.txt')
    ...
    while True:
        if os.path.exists('Cookie_FB.txt'):
            print(f'{luc}Nhập {vang}[{trang}1{vang}] {luc}Sử Dụng Cookie Facebook Đã Lưu ')
            print(f'{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Cookie Facebook Mới')
            chon = Write.Input(f'Nhập Lựa Chọn Của Bạn: ',Colors.purple_to_blue,interval=0.0001)
            if chon == '1':
    ...
    banner()
    print(red+"-"*70)
    print(f"{luc}Tên Tài Khoản: {trang}{user} | {luc}Xu Hiện Tại: {trang}{sodu} | {luc}Số Nick Facebook: {trang}{len(listck)}")
    print(red+"-"*70)
    Write.Print('''[1] - LIKEVIP\n[2] - LIKETHUONG\n[3] - REACTIONVIP\n[4] - REACTION\n[5] - REACTIONCMT\n[6] - CMTCHEO\n[7] - SHARE\n[8] - LIKEPAGE\n[9] - FOLLOW\n[X] - Có Thể Chọn Nhiều Nhiệm Vụ (VD: 123...)\n''',Colors.green_to_white,interval=0.0001)
    print(red+"-"*70)
    nhiemvu = input (f'\033[1;32mNhập Nhiệm Vụ Cần Chạy{trang}: ')
    min = int(input(f'\033[1;32mNhập Delay Min{trang}: '))
    max = int(input(f'\033[1;32mNhập Delay Max{trang}: '))
    nvblock = int(input(f'\033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Chống Block{trang}: '))
    delaybl = int(input(f'\033[1;32mSau {trang}{nvblock} \033[1;32mNhiệm Vụ Thì Nhiệm Vụ Nghỉ Ngơi{trang}: '))
    doinick = int(input(f'\033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick{trang}: '))
    nhiemvuloi = int(input(f'\033[1;32mLỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie{trang}: '))
    while True:
        if len(listck) == 0:
        ...
        for ck in listck:
            ...
            if '1' in cauhinh:
                print(red+"-"*70)
                print(luc+f"      Đang Chạy UID FB: {vang}{uidfb} {red}| {luc}Tên FB: {vang}{tenfb}")
                print(red+"-"*70)
            else:
                print(red+"-"*70)
                print(luc+f"  Cấu Hình Thất Bại UID FB: {vang}{uidfb} {red}| {luc}Tên FB: {vang}{tenfb}")
                print(red+"-"*70)
                continue
            ptool = 0
            while True:
                ...
                if nvlikevip == 1:
                    ...
                    if like1 == []:
                        ...
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        nvlikevip = 0
                    else:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                print(f"{luc}FAIL {lam}LIKE{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEVIP{red}][{trang}{uid}{red}][{luc}+1100{red}][{vang}{xu}{red}]')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvlikethuong == 1:
                    ...
                    like2 = listlike.json()
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Like Thường                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikethuong = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Like Xu Thường                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKETHUONG{red}][{trang}{uid}{red}][{luc}+300{red}][{vang}{xu}{red}]')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvreacvip == 1:
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                print(f"{luc}FAIL {lam}{typee}{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loicamxuc += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{typee}VIP{red}][{trang}{uid}{red}][{luc}+1100{red}][{vang}{xu}{red}]')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loicamxuc >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'{red}Tài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Cảm Xúc {red}!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvreac == 1:
                    ...
                    like2 = listcx.json()
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Cảm Xúc                           ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreac = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cảm Xúc                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{typee}{red}][{trang}{uid}{red}][{luc}+700{red}][{vang}{xu}{red}]')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvreaccmt == 1:
                    ...
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Cảm Xúc Cmt             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreaccmt = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                print(f"{luc}FAIL {lam}{typee} CMT{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loicxcmt += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{typee}CMT{red}][{trang}{uid}{red}][{luc}+700{red}][{vang}{xu}{red}]')
                                    loicxcmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvfollow == 1:
                    ...
                    like2 = listfl.json()
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Follow              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvfollow = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Follow                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if like == False:
                                print(f"{luc}FAIL {lam}FOLLOW{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loifl += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}FOLLOW{red}][{trang}{uid}{red}][{luc}+700{red}][{vang}{xu}{red}]')
                                    loifl = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loifl >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'{red}Tài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Follow {red}!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvcmt == 1:
                    ...
                    like2 = cmtcheo.json()
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Cmt              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvcmt = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cmt                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}CMTCHEO{red}][{trang}{uid}{red}][{luc}+1400{red}][{vang}{xu}{red}]')
                                    loicmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loicmt >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'{red}Tài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Cmt {red}!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvshare == 1:
                    ...
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Share              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvshare = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Share                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if share == False:
                                print(f"{luc}FAIL {lam}SHARE{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loishare += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}SHARE{red}][{trang}{uid}{red}][{luc}+600{red}][{vang}{xu}{red}]')
                                    loishare = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loishare >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'{red}Tài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Share {red}!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvlikepage == 1:
                    ...
                    if like1 == []:
                        print(f'{luc}Hết Nhiệm Vụ Like Page             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikepage = 0
                    elif 'error' in like2:
                        print(f'{luc}Lấy nhiệm vụ sau 17 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(17)
                        ...
                        print(f'{luc}Tìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Like Page                     ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if likepage == False:
                                print(f"{luc}FAIL {lam}LIKEPAGE{trang}: {vang}{uid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loilikepage += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEPAGE{red}][{trang}{uid}{red}][{luc}+1300{red}][{vang}{xu}{red}]')
                                    loilikepage = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loilikepage >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'{red}Tài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Like Page{red}!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if loilike + loicamxuc + loicxcmt + loifl + loicmt + loishare + loilikepage == 0:
                    for i in range(10, 0, -1):
                        Write.Print(f' Tất Cả Các Nhiệm Vụ Đã Hết, Vui Lòng Chờ {i} Giây ',Colors.blue_to_cyan,interval=0.0001, end = '\r');sleep(1); print('                                                        ', end = '\r')
