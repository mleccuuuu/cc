...
def auto_click():
    ...
    while True:
        delay = 5  # Đặt delay mặc định 5 giây
        if click_tiktok_buttons(toa_do_nut, delay):
            pass#print(f"Đã click, chờ {delay} giây trước lần tiếp theo...")
        else:
            pass#print("Lỗi click, thử lại sau 5 giây...")
            time.sleep(3)
        time.sleep(delay)


# Khởi chạy auto_click mà không chặn chương trình chính
